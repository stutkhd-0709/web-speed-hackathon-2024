...
export const Footer: React.FC = () => {
  ...
  const footerContentHeight = 74; // paddingなし

  return (
    <Box as="footer" backgroundColor={Color.Background} height={footerContentHeight} p={Space * 1}>
      <Flex align="flex-start" direction="column" gap={Space * 1} justify="flex-start">
        <img alt="Cyber TOON" height={45} src="/assets/cyber-toon.webp" width={189} />
